...
public class ConsumerInvokerManager {
	...
	protected static final String ERR_PARAMETERS_TYPE_WRONG = "parameter`s lemgth is wrong,or one or more parameter`s type is wrong";
	...
	{
		logger.info("invoker-args:|interfaceName:"+interfaceName+"|methodName:"+methodName+"|paras:"+paras.toString()+"|group:"+group);
